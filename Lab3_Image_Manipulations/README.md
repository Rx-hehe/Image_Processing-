...
* [Lab3_Image_Mnupilatioins.ipynb](Lab3_Image_Mnupilations.ipynb) — Complete Jupyter execution notebook containing output convolution matrices, filtering pipelines, and comparative visualizations.
